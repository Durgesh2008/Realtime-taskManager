    ...
    <>
      <div className="bg-blue-200 shadow-lg h-[80%]  rounded lg:p-8 md:p-5 p-2 md:mx-4 lg:mx-10 mx-2 my-3">
        <div className="flex justify-between items-center">
          ...
          <button
            className="px-3 py-1 bg-blue-400 rounded-md text-white outline-none focus:ring-4 shadow-lg transform active:scale-75 transition-transform"
        ...
        <div className="scrollable-container overflow-auto max-h-[70vh] max-w-[95vw] p-2">
          {children}
        </div>
      </div>
